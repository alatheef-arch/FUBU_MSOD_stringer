# /layouts/tabs/tab_stringer.py
"""Defines the layout for stringer tab of dash application"""
...
card_body_content = [
    ...
    html.Div(
        id="global-props-status-output",
        className="mt-2",
    ),
]

stringer_tab_layout = dbc.Tab(
    label="Stringer",
    tab_id="tab-3",
    children=[
        create_tab_content_layout(
